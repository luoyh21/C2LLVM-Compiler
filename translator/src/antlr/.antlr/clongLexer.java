...
public class clongLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__33", "T__34", "T__35", "T__36", "T__37", "T__38", "PAR", "INT", "DOUBLE", 
			"CHAR", "STRING", "LineComment", "BlockComment", "DELIMITER"
		};
	}
	...
	public clongLexer(CharStream input) {
		super(input);
